...
class newFoodPage extends StatefulWidget {
  ...
  const newFoodPage({
    required this.newFOODimg,
    required this.newFOODname,
    required this.newRRICE,
    required this.newResNAME,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage(widget.newFOODimg),
                    )),
                child: Stack(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        "delivery price ${widget.newRRICE}",
